        ...
        <div className="space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                    ...
                    <button type="button" onClick={handleClose} className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 font-medium text-sm hover:bg-red-100 dark:hover:bg-red-900/40 transition-all">
                        <XCircle className="w-4 h-4" />
                        Fermer
                    </button>
                    <button type="button" onClick={handleNewBon} className="btn-secondary text-sm py-2 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-800 dark:text-white">
